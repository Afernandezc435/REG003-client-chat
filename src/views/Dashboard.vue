    ...
    <div class="bg-indigo-darker text-purple-lighter flex-none w-64 pb-6 hidden md:block">
      <div class="text-white mb-2 mt-3 px-4 flex justify-between">
        <div class="flex-auto">
          ...
          <div class="flex items-center mb-6">
            <span class="bg-green rounded-full block w-2 h-2 mr-2" />
      ...
      <div class="mb-8">
        ...
        <div class="flex items-center px-4 mb-6 opacity-50">
          <span class="border border-white rounded-full w-2 h-2 mr-2" />
        ...
        <div class="flex items-start mb-4 text-sm">
          ...
          <div class="flex-1 overflow-hidden">
            ...
            <p class="text-black leading-normal">
              ...
              >@Adam Wathan</a> the size of the generated CSS is creating a singularity in space/time, we must stop adding more utilities before it's too late!
            </p>
          </div>
        </div>
        <!-- A message -->
